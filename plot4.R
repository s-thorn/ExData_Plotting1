...
## To create Plot 4
## Set parameters to 2 columns and 2 rows
par(mfcol=c(2,2))
## Insert Plot 1
...
## Insert third plot
plot(as.POSIXlt(Feb1and2$datetime), Feb1and2$Voltage, type="l", xlab="datetime", ylab="Voltage")
## Insert fourth plot
plot(as.POSIXlt(Feb1and2$datetime), Feb1and2$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
## Save as PNG file
